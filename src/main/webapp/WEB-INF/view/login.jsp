                ...
                <div class="row">
                    <div class="col d-flex flex-row">
                        ...
                        <div class="user_box ml-auto">
                            ...
                            <div class="user_box_register user_box_link"><a href="${APP_PATH}/logout.do">logout</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="search_tabs_container">
                                        <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                            <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
                                                <h4><i class="fa fa-plane" aria-hidden="true"></i>&nbsp;Search flights
                                                </h4></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="search_panel">
                                        <form id="search_form_1" class="form-group">
                                                ...
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn btn-agile active">
                                                        <input type="radio" name="options" id="option1"
                                                               autocomplete="off" value="one-way" checked> <i
                                                            class="fa fa-long-arrow-right"></i>&nbsp;One Way Ticket
                                                    </label>
                                                    <label class="btn btn-agile">
                                                        <input type="radio" name="options" id="option2"
                                                               autocomplete="off" value="return"> <i
                                                            class="fa fa-exchange"></i>&nbsp;Return Ticket
                                                    </label>
                                                </div>
                                                <br/>&nbsp;
                                            </div>
                                            ...
                                            <div class="search_item">
                                                ...
                                                <select name="origin" id="origin_city"
                                            ...
                                            <div class="search_item">
                                                ...
                                                <select name="destination" id="destination_city"
                                                        class="form-control custom-select custom-select-lg mb-3">
                                                    <c:if test="${not empty cities}">
                                                        <c:forEach var="city" items="${cities}">
                                                            <option value="${city.cityid}">${city.cityname}</option>
                                            ...
                                            <div class="search_item">
                                                ...
                                                <input name="traveldate"
                                                       class="travel_date form-control contact_form_name date form_date"
                                                       size="16" type="text" value="" placeholder="yyyy/mm/dd">
                                            </div>
                                            <div class="search_item">
                                                <div>Seat Preference</div>
                                                <select name="seat" id="seat_preference"
                                                        class="form-control custom-select custom-select-lg mb-3">
                ...
                <div class="col-md-5">
                    ...
                    <div class="elements_accordions">
                        ...
                        <div class="accordion_container">
                            <div class="accordion d-flex flex-row align-items-center <%= i==0?"active":"" %>">
                                <div><%=origin%> to <%=destination%> (<%=fromDate%>)</div>
                            </div>
                            <div class="accordion_panel">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tr>
                                            <td><%= orderFlight.getFlightOrigin() %>
                                            </td>
                                            <td><%= orderFlight.getFlightDestination() %>
                                            </td>
                                            <td><%= orderFlight.getSeatType() %>
                                            </td>
                                            <td><%= orderFlight.getPaymentStatus() %>
                                            </td>
                                            <td><%=   new SimpleDateFormat("dd-MMM-yy").format(orderFlight.getFlightDate()) %>
                                            </td>
                                            <td><%=  new SimpleDateFormat("HH:mm").format(orderFlight.getFlightTime()) %>
                                            </td>
                                        </tr>
                                        <% } %>
                                        </tbody>
